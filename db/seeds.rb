...
admin1 = Admin.create!(name: "Ashley", email: "ashley.huynh23@gmail.com", password: "Loki123!")

pp "#{Admin.count} admin created"
...
meas_realty = Project.create!(project_title: "Meas Realty", about: "Meas Realty is a virtual real estate brokerage located in California.", github_url: "https://github.com/ashleymhuynh/Meas-Realty", deploy_url: "https://www.measrealty.com/", admin_id: admin1[:id], image_url: "https://i.imgur.com/1dsYNd9.png", languages: "Javascript | CSS | React")
